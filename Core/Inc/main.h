...
/* Private defines -----------------------------------------------------------*/
#define EWDT_FEED_Pin GPIO_PIN_6
#define EWDT_FEED_GPIO_Port GPIOE
#define USB_RX_Pin GPIO_PIN_0
#define USB_RX_GPIO_Port GPIOC
#define USB_TX_Pin GPIO_PIN_1
#define USB_TX_GPIO_Port GPIOC
#define SENS_3V3_Pin GPIO_PIN_0
#define SENS_3V3_GPIO_Port GPIOA
#define SENS_3V8_Pin GPIO_PIN_1
#define SENS_3V8_GPIO_Port GPIOA
#define SENS_5V_Pin GPIO_PIN_2
#define SENS_5V_GPIO_Port GPIOA
#define USER_HARD_RESET_SW_Pin GPIO_PIN_3
...
#define NTC_SENS_Pin GPIO_PIN_9
#define NTC_SENS_GPIO_Port GPIOD
#define VPV_SENS_Pin GPIO_PIN_10
#define VPV_SENS_GPIO_Port GPIOD
#define VBAT_SENS_Pin GPIO_PIN_11
#define VBAT_SENS_GPIO_Port GPIOD
#define CHARGER_SCL_Pin GPIO_PIN_12
#define CHARGER_SCL_GPIO_Port GPIOD
#define CHARGER_SDA_Pin GPIO_PIN_13
#define CHARGER_SDA_GPIO_Port GPIOD
#define CHARGER_STAT_Pin GPIO_PIN_14
#define CHARGER_STAT_GPIO_Port GPIOD
#define CHARGER_INT_Pin GPIO_PIN_15
#define CHARGER_INT_GPIO_Port GPIOD
#define CHARGER_ENABLE_Pin GPIO_PIN_6
#define CHARGER_ENABLE_GPIO_Port GPIOC
#define CHARGER_FET_Pin GPIO_PIN_7
#define CHARGER_FET_GPIO_Port GPIOC
#define RELAY1_PWM_Pin GPIO_PIN_8
#define RELAY1_PWM_GPIO_Port GPIOC
#define RELAY2_PWM_Pin GPIO_PIN_9
...
#define MODBUS_OE_Pin GPIO_PIN_15
...
#define GSM_ONOFF_Pin GPIO_PIN_8
#define GSM_ONOFF_GPIO_Port GPIOB
#define GSM_SHUTDOWM_Pin GPIO_PIN_9
#define GSM_SHUTDOWM_GPIO_Port GPIOB
#define GSM_SW_RDY_Pin GPIO_PIN_0
