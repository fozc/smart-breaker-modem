/*
 * gpio_defs.h — Smart Breaker Modem board pin definitions
 */
#ifndef BSP_GPIO_DEFS_H_
#define BSP_GPIO_DEFS_H_

/*
 * Include gpio.h for GPIO_A..H and PIN_0..15 enum definitions.
 * gpio.h includes gpio_defs.h first, but header guards prevent recursion.
 */
#include "gpio.h"
